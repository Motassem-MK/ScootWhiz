...
class UpdateTripTest extends TestCase
{
    ...
    private const ENDPOINT = '/scooter/trip/update';

    public function testShouldUpdateTrip(): void
    {
        ...
        $updateTime = $startTime->addSeconds(5);
        ...
        $this->assertDatabaseHas(EloquentModelHelper::getTableName(ScooterLocation::class), [
            ...
            'latitude' => $lat,
            'longitude' => $long,
            'received_at' => $updateTime,
        ]);
    }

    public function testShouldNotUpdateEndedTrip(): void
    {
        $scooter = (new ScooterFactory())->occupied()->create();
        $client = (new ClientFactory())->create();
        $lat = 40.7128564;
